...
/**
 * This is a class called CST462S which is being called from
 ...
 * A description will be presented for CST 462S.
 */
public class cST462S extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        //Calls the super from onCreate.
        super.onCreate(savedInstanceState);
        //Sets content view base on the XML file.
        setContentView(R.layout.cst462s);
