...
/**
 * This is a class called CST336 which is being called from
 ...
 * A description will be presented for CST 336.
 */
public class cST336 extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        //Calls the super from onCreate.
        super.onCreate(savedInstanceState);
        //Sets content view base on the XML file.
        setContentView(R.layout.cst336);
